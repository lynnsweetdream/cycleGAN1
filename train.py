...
parser.add_argument('--epoch', dest='epoch', type=int, default=50, help='# of epoch')  # 训练的epoch数量200
parser.add_argument('--epoch_step', dest='epoch_step', type=int, default=25, help='# of epoch to decay lr')  # 训练中保持学习率不变的epoch数量100
...
parser.add_argument("--write_pred_every", type=int, default=1000, help="times to write.")  # 训练中每过多少step保存可视化结果100
